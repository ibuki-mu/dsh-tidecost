						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										"支持 ",
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: "DeepSeek" }),
										"（余额 / 峰谷价）与 ",
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: "Z.ai" }),
										"（按量计费：输入 ¥0.8 / 缓存命中 ¥0.23 / 输出 ¥2.8 每 1M tokens）。其他 provider 无定价表，费用为 Flash 兜底估算，仅供参考。"
									]
								})
							]
						})]
