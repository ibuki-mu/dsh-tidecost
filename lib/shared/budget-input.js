/**
 * dsh-balance — 预算输入框的纯文本/数值转换（客户端表单编辑态）。
 *
 ...
 *  - 允许空串（清空时不再被强制补 0）。
 */
export function sanitizeNumText(raw) {
...
/** 服务端预算 → 编辑态字符串。 */
export function budgetToDraft(b) {
    return {
...
export function draftToBudget(d) {
    return {
...
//# sourceMappingURL=budget-input.js.map